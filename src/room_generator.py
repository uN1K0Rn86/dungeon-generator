...
def place_rooms(width, height, room_maxwidth, room_maxheight, rooms):
    """
    Place rooms into a dungeon based on dungeon width and height,
    maximum width and height per room, and amount of rooms.
    ...
    Returns:
        A list of lists containing the dungeon with the placed rooms
        and the amount of remaining tries to place the last room.
    """
    ...
    for i in range(rooms):
        ...
        while overlap and tries > 0:
            ...
            # Randomly select the upper left corner location for the
            # room so that it is not at the edge of the dungeon
